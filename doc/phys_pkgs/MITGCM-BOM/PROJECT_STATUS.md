...
2. 核对 P4.3 生产提交 `852659089`、`7a14707da`、`460d42890`
   及收口提交均为 WangYuLin；
3. 核对 `p43-final-head-attempt01` 的 26/26、
   `p43-p42-accepted-attempt01` 的 18/18、
   `p43-p41-accepted-attempt01` 的 31/31 与
   `p43-predecessor-final-head-attempt01` 的 538/538、source-head 和
   manifest 自校验；
...
- `p43-final-head-attempt01` 在洁净精确头通过 26/26；
- `p43-p42-accepted-attempt01` 通过 P4.2 18/18，
  `p43-p41-accepted-attempt01` 以 p43 scope 通过 P4.1 31/31；
- 隔离 shared clone 的 `p43-predecessor-final-head-attempt01` 通过
...
- P4.3 production migration 共用新的 packet validator，所有验证发生在
  ...
  都通过；
- clean closeout 证据为 `p43-final-head-attempt01` 26/26、
  `p43-p42-accepted-attempt01` 18/18、`p43-p41-accepted-attempt01`
  31/31 和 `p43-predecessor-final-head-attempt01` 538/538；
