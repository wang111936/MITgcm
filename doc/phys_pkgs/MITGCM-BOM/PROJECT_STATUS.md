...
2. 核对 P4.3 生产提交 `852659089`、`7a14707da`、`460d42890`
   及收口提交均为 WangYuLin；
3. 核对 `p43-final-head-attempt03` 的 26/26、
   `p43-p42-accepted-attempt03` 的 18/18、
   `p43-p41-accepted-attempt03` 的 31/31 与
   `p43-predecessor-final-head-attempt03` 的 538/538、source-head 和
   manifest 自校验；
...
- `p43-final-head-attempt03` 在洁净精确头通过 26/26；
- `p43-p42-accepted-attempt03` 通过 P4.2 18/18，
  `p43-p41-accepted-attempt03` 以 p43 scope 通过 P4.1 31/31；
- 隔离 shared clone 的 `p43-predecessor-final-head-attempt03` 通过
...
- 首次 predecessor 尝试在 P3 小容量 `BOM_SIZE.h` 缺少新的
  ...
  改动 schema2 值或容量；
- clean closeout 证据为 `p43-final-head-attempt03` 26/26、
  `p43-p42-accepted-attempt03` 18/18、`p43-p41-accepted-attempt03`
  31/31 和 `p43-predecessor-final-head-attempt03` 538/538；
