...
- phase03-integration-closure/: integrated P3-G99 and independent exit-audit
  drivers;
- phase04-biology-land/: P4.0 source/interface/test freeze for accepted T/N
  endpoints, Brooks biology, terminal state/events, compact-tail reuse,
  deterministic Philox births/IDs, schema 4, B11--B15/B17--B19 and P4-G99;
