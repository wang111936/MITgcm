# P1.2 first mapping increment test plan
...
This increment does not call or replace `BOM_LOCATE_INITIAL`, construct ocean
velocity fields, interpolate environmental fields, or move particles.
